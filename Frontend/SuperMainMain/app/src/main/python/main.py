...
def validate_news(url, news):
    ...
    urlsdsd = "sdsdsd"
    joblib.dump(urlsdsd, "detector_pipeline.joblib")
    # F:\Education\IIT\2nd Year\2nd Semester\SDGP Implementation\GIT Repo\SDGP_Stuff\Frontend\SuperMainMain\app\src\main\python
