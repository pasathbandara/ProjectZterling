    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener {
            when(it.itemId){
                ...
                R.id.nav_login -> Toast.makeText(applicationContext,"Logout",Toast.LENGTH_SHORT).show()
                R.id.nav_rating -> Toast.makeText(applicationContext,"Rating",Toast.LENGTH_SHORT).show()
